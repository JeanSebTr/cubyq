...
game.PlayerRemote.prototype.serialize= function() {
  var tmp = {};
  tmp.id = this.id;
  tmp.x = this.x;
  tmp.y = this.y;
...
game.PlayerRemote.prototype.update = function(deltaTime) {
  ...
  //  this.x += Math.cos(this.angle) * Game.controler.UP * this.velocity * deltaTime / 1000;
  //  this.y += Math.sin(this.angle) * Game.controler.UP * this.velocity * deltaTime / 1000;
  //}
  //if (Game.controler.DOWN) {
  //  this.x -= Math.cos(this.angle) * Game.controler.DOWN * this.velocity * deltaTime / 1000;
  //  this.y -= Math.sin(this.angle) * Game.controler.DOWN * this.velocity * deltaTime / 1000;
  //}
  //if (Game.controler.LEFT) {
  //  this.x += Math.cos(this.angle - Math.PI / 2) * Game.controler.LEFT * this.velocity * deltaTime / 1000;
  //  this.y += Math.sin(this.angle - Math.PI / 2) * Game.controler.LEFT * this.velocity * deltaTime / 1000;
  //}
  //if (Game.controler.RIGHT) {
  //  this.x += Math.cos(this.angle + Math.PI / 2) * Game.controler.RIGHT * this.velocity * deltaTime / 1000;
  //  this.y += Math.sin(this.angle + Math.PI / 2) * Game.controler.RIGHT * this.velocity * deltaTime / 1000;
  //}
