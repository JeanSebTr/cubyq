...
GameEngine.prototype.init = function(canvasId) {
  ...
  this.bobetteManager = new game.BobetteManager();
  this.toiletPaperManager = new game.ToiletPaperManager();

  // Add some objects.
  for (var i = 0; i < 10; i++) {
    this.rectManager.push(new game.Rect({ x: 0, y: 0, w: 10, h: 10 }));
    this.bobetteManager.push(new game.Bobette({ x: jx.Utils.rand(100, 500), y: jx.Utils.rand(100, 500), w: 10, h: 10 }));
  }
