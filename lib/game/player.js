...
game.Player.prototype.update = function(deltaTime) {
  ...
  if (Game.controler.LEFT) {
    this.x += Math.cos(this.angle - Math.PI / 2) * Game.controler.LEFT * this.velocityMax * deltaTime / 1000;
    this.y += Math.sin(this.angle - Math.PI / 2) * Game.controler.LEFT * this.velocityMax * deltaTime / 1000;
  }
  if (Game.controler.RIGHT) {
    this.x += Math.cos(this.angle + Math.PI / 2) * Game.controler.RIGHT * this.velocityMax * deltaTime / 1000;
    this.y += Math.sin(this.angle + Math.PI / 2) * Game.controler.RIGHT * this.velocityMax * deltaTime / 1000;
  }
